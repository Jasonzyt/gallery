<template>
  ...
  <div class="relative h-full">
    ...
    <button
      @click="toggleMenu"
      v-show="!isMenuOpen"
      class="fixed top-4 left-4 z-30 bg-white dark:bg-[#0f172b] rounded-md p-2 shadow-md hidden max-sm:flex items-center justify-center"
    ...
    >
      <h2 class="px-4 pt-4 pb-2.5 text-2xl">
        <Icon
          name="my:gallery"
          size="1.4em"
          class="align-text-bottom mr-2.5"
        />Gallery
      </h2>
      ...
      <UNavigationMenu
        ...
        :ui="{
          root: 'w-full',
          link: 'py-2.5 px-[8%] text-[1.1rem]',
          linkLeadingIcon: 'text-xl mr-1',
        }"
      >
      </UNavigationMenu>
      <div class="grow"></div>
