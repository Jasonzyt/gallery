      ...
      >
        <Transition name="slide" mode="out-in">
          ...
          >
            ...
            <Transition name="fade">
              <div
                v-show="!isTouchDevice && showInfoTrigger && !showInfo"
            ...
            <Transition name="fade-scale">
              <div
                v-show="
                  (isTouchDevice || (!isTouchDevice && showInfoTrigger)) &&
                  !showInfo
                "
                ...
                @click="handleInfoToggleClick"
                ref="infoToggleRef"
              >
                <Icon
                  name="i-heroicons-information-circle"
                  class="text-2xl text-white mr-2"
                />
            ...
            <Transition name="slide-up">
              ...
              >
                <UCard
                  class="bg-transparent ring-0 px-4 pt-4 sm:px-6 sm:pt-6 z-[100]"
                  :ui="{ body: 'p-0 sm:p-0' }"
                >
                  ...
                  <div
                    class="overflow-y-scroll max-h-[65vh] sm:max-h-[90vh] info-scroll-bar"
                  >
                    <div
                      v-for="(obj, category) in exifData"
                      :key="category"
                      class="mb-2"
                    >
        ...
        <div
          v-show="hasPrevious && !isLoading && !showInfo"
        ...
        >
          <Icon
            ...
            class="text-3xl sm:text-2xl text-white"
          />
        </div>

        <div
          v-show="hasNext && !isLoading && !showInfo"
...
const handleClick = (e: MouseEvent) => {
  ...
  const isClickOnNav =
    target.closest(".absolute.left-0") || target.closest(".absolute.right-0");
